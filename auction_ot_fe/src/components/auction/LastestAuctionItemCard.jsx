...
const LastestAuctionItemCard = ({ props }) => {
  const { days, hours, minutes, seconds } = useCountdownTimer(props.startTime);
    ...
    >
      <div className="auction-card">
        ...
        <div className="auction-card-content">
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <span style={{ color: "#23291fbb" }}>Bắt đầu:</span>
            <span style={{ fontWeight: "bold", marginRight: "10px" }}>
              {formatDate(props.startTime)}
            </span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <span style={{ color: "#23291fbb" }}>Kết thúc:</span>
            <span style={{ fontWeight: "bold", marginRight: "10px" }}>
...
export default LastestAuctionItemCard;
