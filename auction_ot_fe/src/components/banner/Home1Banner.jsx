...
const Home1Banner = () => {
  return (
    ...
    //     style={{
    //       backgroundImage:
    //         "linear-gradient(180deg, rgba(11, 12, 12, 0.65) 0%, rgba(11, 12, 12, 0.65) 100%), url(assets/img/home1/home1-banner-bg.jpg)",
    //     }}
    //   >
    ...
    //           <Link className="primary-btn btn-hover" href="/auction-grid">
    //             Start A Bid
    //             <svg
    //               width={11}
    //               height={11}
    ...
    //           </Link>
    //           <Link
    //             className="primary-btn btn-hover white-bg"
    //             href="/auction-grid"
    //           >
    //             View All Auction
    //             <span style={{ top: "40.5px", left: "84.2344px" }} />
