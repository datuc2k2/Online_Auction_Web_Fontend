...
`;
export const ChartPointHorizontal = Styled.div`
...
`;
export const TableDefaultStyle = Styled.div`
...
export const BtnWithIcon = Styled.div`
    display: inline;
    .anticon i,
    .anticon svg,
    .anticon img{
...
export const MessageStyleWrapper = Styled.div`
    .ant-btn-lg{
        font-size: 14px;
    }
`;
...
export const CardToolbox = Styled.div`
    margin: 16px 0 10px;
    @media only screen and (max-width: 767px){
        margin: 8px 0 2px;
    }
...
`;
export const BannerCardStyleWrap = Styled.div`
    .ant-card-body{
...
export const ImportStyleWrap = Styled.div`
    @media only screen and (max-width: 575px){
        margin-top: 10px;
    }
...
export const ExportStyleWrap = Styled.div`
...
export const CollapseStyleWrap = Styled.div`
    .ant-collapse{
        background-color: transparent !important;
        > .ant-collapse-item{
            margin-bottom: 5px;
